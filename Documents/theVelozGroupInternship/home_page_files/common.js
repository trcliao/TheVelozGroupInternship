...
function addToCart(product_id, quantity) {
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				$('#notification').html('<div class="success" style="display: none;">' + json['success'] + '<img src="catalog/view/theme/helios/image/remove-notification.png" alt="" class="close" /></div>');
...
function removeFromCart(product_id) {
	$.ajax({
		...
		success: function(html) {
			...
			$('#sidecart .box-right-sidecart-content').html($(".content > *", $(html)));
		}
	});
}
